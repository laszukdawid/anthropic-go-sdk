...
// Defines values for BetaMessageRole.
const (
	BetaMessageRoleAssistant BetaMessageRole = "assistant"
)

// Defines values for BetaMessageStopReason0.
const (
	BetaMessageStopReason0EndTurn      BetaMessageStopReason0 = "end_turn"
	BetaMessageStopReason0MaxTokens    BetaMessageStopReason0 = "max_tokens"
	BetaMessageStopReason0StopSequence BetaMessageStopReason0 = "stop_sequence"
	BetaMessageStopReason0ToolUse      BetaMessageStopReason0 = "tool_use"
)

// Defines values for BetaMessageType.
const (
...
// Defines values for BetaResponseTextBlockType.
const (
	BetaResponseTextBlockTypeText BetaResponseTextBlockType = "text"
)

// Defines values for BetaResponseToolUseBlockType.
const (
	BetaResponseToolUseBlockTypeToolUse BetaResponseToolUseBlockType = "tool_use"
)
...
type BetaBashTool20241022 struct {
	CacheControl *BetaBashTool20241022_CacheControl `json:"cache_control,omitempty"`
...
// BetaContentBlock defines model for BetaContentBlock.
...
// BetaMessage defines model for BetaMessage.
type BetaMessage struct {
	...
	// [{"type": "text", "text": "B)"}]
	// ```
	Content []BetaContentBlock `json:"content"`
	...
	Role BetaMessageRole `json:"role"`
	...
	StopReason *BetaMessage_StopReason `json:"stop_reason"`

	// StopSequence Which custom stop sequence was generated, if any.
	//
	// This value will be a non-null string if one of your custom stop sequences was generated.
	StopSequence *BetaMessage_StopSequence `json:"stop_sequence"`

	// Type Object type.
	//
	// For Messages, this is always `"message"`.
	Type BetaMessageType `json:"type"`
...
// BetaMessageRole Conversational role of the generated message.
//
// This will always be `"assistant"`.
type BetaMessageRole string

// BetaMessageStopReason0 defines model for BetaMessage.StopReason.0.
type BetaMessageStopReason0 string

// BetaMessage_StopReason The reason that we stopped.
//
// This may be one the following values:
// * `"end_turn"`: the model reached a natural stopping point
// * `"max_tokens"`: we exceeded the requested `max_tokens` or the model's maximum
...
//
// In non-streaming mode this value is always non-null. In streaming mode, it is null in the `message_start` event and non-null otherwise.
type BetaMessage_StopReason struct {
	union json.RawMessage
}

// BetaMessageStopSequence0 defines model for .
type BetaMessageStopSequence0 = string

// BetaMessage_StopSequence Which custom stop sequence was generated, if any.
//
// This value will be a non-null string if one of your custom stop sequences was generated.
type BetaMessage_StopSequence struct {
	union json.RawMessage
}

// BetaMessageType Object type.
//
// For Messages, this is always `"message"`.
...
// BetaResponseTextBlock defines model for BetaResponseTextBlock.
type BetaResponseTextBlock struct {
	Text string                    `json:"text"`
	Type BetaResponseTextBlockType `json:"type"`
}

// BetaResponseTextBlockType defines model for BetaResponseTextBlock.Type.
type BetaResponseTextBlockType string

// BetaResponseToolUseBlock defines model for BetaResponseToolUseBlock.
type BetaResponseToolUseBlock struct {
	Id    string                       `json:"id"`
	Input map[string]interface{}       `json:"input"`
	Name  string                       `json:"name"`
	Type  BetaResponseToolUseBlockType `json:"type"`
}

// BetaResponseToolUseBlockType defines model for BetaResponseToolUseBlock.Type.
type BetaResponseToolUseBlockType string
...
// BetaUsage defines model for BetaUsage.
type BetaUsage struct {
	// CacheCreationInputTokens The number of input tokens used to create the cache entry.
	CacheCreationInputTokens *BetaUsage_CacheCreationInputTokens `json:"cache_creation_input_tokens"`

	// CacheReadInputTokens The number of input tokens read from the cache.
	CacheReadInputTokens *BetaUsage_CacheReadInputTokens `json:"cache_read_input_tokens"`
...
// BetaUsageCacheCreationInputTokens0 defines model for .
type BetaUsageCacheCreationInputTokens0 = int

// BetaUsage_CacheCreationInputTokens The number of input tokens used to create the cache entry.
type BetaUsage_CacheCreationInputTokens struct {
	union json.RawMessage
}

// BetaUsageCacheReadInputTokens0 defines model for .
type BetaUsageCacheReadInputTokens0 = int

// BetaUsage_CacheReadInputTokens The number of input tokens read from the cache.
type BetaUsage_CacheReadInputTokens struct {
	union json.RawMessage
}
...
// BetaMessagesPostParams defines parameters for BetaMessagesPost.
type BetaMessagesPostParams struct {
	// AnthropicBeta Optional header to specify the beta version(s) you want to use.
	//
	// To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
	AnthropicBeta *string `json:"anthropic-beta,omitempty"`
...
// BetaMessagesPostJSONRequestBody defines body for BetaMessagesPost for application/json ContentType.
type BetaMessagesPostJSONRequestBody = BetaCreateMessageParams
...
// AsBetaResponseTextBlock returns the union data inside the BetaContentBlock as a BetaResponseTextBlock
func (t BetaContentBlock) AsBetaResponseTextBlock() (BetaResponseTextBlock, error) {
	var body BetaResponseTextBlock
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaResponseTextBlock overwrites any union data inside the BetaContentBlock as the provided BetaResponseTextBlock
func (t *BetaContentBlock) FromBetaResponseTextBlock(v BetaResponseTextBlock) error {
	v.Type = "text"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeBetaResponseTextBlock performs a merge with any union data inside the BetaContentBlock, using the provided BetaResponseTextBlock
func (t *BetaContentBlock) MergeBetaResponseTextBlock(v BetaResponseTextBlock) error {
	v.Type = "text"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsBetaResponseToolUseBlock returns the union data inside the BetaContentBlock as a BetaResponseToolUseBlock
func (t BetaContentBlock) AsBetaResponseToolUseBlock() (BetaResponseToolUseBlock, error) {
	var body BetaResponseToolUseBlock
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaResponseToolUseBlock overwrites any union data inside the BetaContentBlock as the provided BetaResponseToolUseBlock
func (t *BetaContentBlock) FromBetaResponseToolUseBlock(v BetaResponseToolUseBlock) error {
	v.Type = "tool_use"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeBetaResponseToolUseBlock performs a merge with any union data inside the BetaContentBlock, using the provided BetaResponseToolUseBlock
func (t *BetaContentBlock) MergeBetaResponseToolUseBlock(v BetaResponseToolUseBlock) error {
	v.Type = "tool_use"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
func (t BetaContentBlock) Discriminator() (string, error) {
	var discriminator struct {
		Discriminator string `json:"type"`
	}
	err := json.Unmarshal(t.union, &discriminator)
...
func (t BetaContentBlock) ValueByDiscriminator() (interface{}, error) {
	discriminator, err := t.Discriminator()
	if err != nil {
		return nil, err
	}
	switch discriminator {
	case "text":
		return t.AsBetaResponseTextBlock()
	case "tool_use":
		return t.AsBetaResponseToolUseBlock()
	default:
		return nil, errors.New("unknown discriminator value: " + discriminator)
	}
}

func (t BetaContentBlock) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *BetaContentBlock) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsBetaMessageStopReason0 returns the union data inside the BetaMessage_StopReason as a BetaMessageStopReason0
func (t BetaMessage_StopReason) AsBetaMessageStopReason0() (BetaMessageStopReason0, error) {
	var body BetaMessageStopReason0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaMessageStopReason0 overwrites any union data inside the BetaMessage_StopReason as the provided BetaMessageStopReason0
func (t *BetaMessage_StopReason) FromBetaMessageStopReason0(v BetaMessageStopReason0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeBetaMessageStopReason0 performs a merge with any union data inside the BetaMessage_StopReason, using the provided BetaMessageStopReason0
func (t *BetaMessage_StopReason) MergeBetaMessageStopReason0(v BetaMessageStopReason0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t BetaMessage_StopReason) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *BetaMessage_StopReason) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsBetaMessageStopSequence0 returns the union data inside the BetaMessage_StopSequence as a BetaMessageStopSequence0
func (t BetaMessage_StopSequence) AsBetaMessageStopSequence0() (BetaMessageStopSequence0, error) {
	var body BetaMessageStopSequence0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaMessageStopSequence0 overwrites any union data inside the BetaMessage_StopSequence as the provided BetaMessageStopSequence0
func (t *BetaMessage_StopSequence) FromBetaMessageStopSequence0(v BetaMessageStopSequence0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeBetaMessageStopSequence0 performs a merge with any union data inside the BetaMessage_StopSequence, using the provided BetaMessageStopSequence0
func (t *BetaMessage_StopSequence) MergeBetaMessageStopSequence0(v BetaMessageStopSequence0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t BetaMessage_StopSequence) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *BetaMessage_StopSequence) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsBetaUsageCacheCreationInputTokens0 returns the union data inside the BetaUsage_CacheCreationInputTokens as a BetaUsageCacheCreationInputTokens0
func (t BetaUsage_CacheCreationInputTokens) AsBetaUsageCacheCreationInputTokens0() (BetaUsageCacheCreationInputTokens0, error) {
	var body BetaUsageCacheCreationInputTokens0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaUsageCacheCreationInputTokens0 overwrites any union data inside the BetaUsage_CacheCreationInputTokens as the provided BetaUsageCacheCreationInputTokens0
func (t *BetaUsage_CacheCreationInputTokens) FromBetaUsageCacheCreationInputTokens0(v BetaUsageCacheCreationInputTokens0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeBetaUsageCacheCreationInputTokens0 performs a merge with any union data inside the BetaUsage_CacheCreationInputTokens, using the provided BetaUsageCacheCreationInputTokens0
func (t *BetaUsage_CacheCreationInputTokens) MergeBetaUsageCacheCreationInputTokens0(v BetaUsageCacheCreationInputTokens0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t BetaUsage_CacheCreationInputTokens) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *BetaUsage_CacheCreationInputTokens) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsBetaUsageCacheReadInputTokens0 returns the union data inside the BetaUsage_CacheReadInputTokens as a BetaUsageCacheReadInputTokens0
func (t BetaUsage_CacheReadInputTokens) AsBetaUsageCacheReadInputTokens0() (BetaUsageCacheReadInputTokens0, error) {
	var body BetaUsageCacheReadInputTokens0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBetaUsageCacheReadInputTokens0 overwrites any union data inside the BetaUsage_CacheReadInputTokens as the provided BetaUsageCacheReadInputTokens0
func (t *BetaUsage_CacheReadInputTokens) FromBetaUsageCacheReadInputTokens0(v BetaUsageCacheReadInputTokens0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeBetaUsageCacheReadInputTokens0 performs a merge with any union data inside the BetaUsage_CacheReadInputTokens, using the provided BetaUsageCacheReadInputTokens0
func (t *BetaUsage_CacheReadInputTokens) MergeBetaUsageCacheReadInputTokens0(v BetaUsageCacheReadInputTokens0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t BetaUsage_CacheReadInputTokens) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *BetaUsage_CacheReadInputTokens) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
type ServerInterface interface {
	...
	// (POST /v1/complete)
	CompletePost(w http.ResponseWriter, r *http.Request, params CompletePostParams)
	// Create a Message
	// (POST /v1/messages)
	MessagesPost(w http.ResponseWriter, r *http.Request, params MessagesPostParams)
	// List Message Batches
	// (GET /v1/messages/batches)
	BetaMessageBatchesList(w http.ResponseWriter, r *http.Request, params BetaMessageBatchesListParams)
	// Create a Message Batch
	// (POST /v1/messages/batches)
	BetaMessageBatchesPost(w http.ResponseWriter, r *http.Request, params BetaMessageBatchesPostParams)
	// Retrieve a Message Batch
	// (GET /v1/messages/batches/{message_batch_id})
	BetaMessageBatchesRetrieve(w http.ResponseWriter, r *http.Request, messageBatchId string, params BetaMessageBatchesRetrieveParams)
	// Cancel a Message Batch
	// (POST /v1/messages/batches/{message_batch_id}/cancel)
	BetaMessageBatchesCancel(w http.ResponseWriter, r *http.Request, messageBatchId string, params BetaMessageBatchesCancelParams)
	// Cancel a Message Batch
	// (POST /v1/messages/batches/{message_batch_id}/cancel?beta=true)
	BetaMessageBatchesCancel(w http.ResponseWriter, r *http.Request, messageBatchId string, params BetaMessageBatchesCancelParams)
	// Retrieve Message Batch results
	// (GET /v1/messages/batches/{message_batch_id}/results)
	BetaMessageBatchesResults(w http.ResponseWriter, r *http.Request, messageBatchId string, params BetaMessageBatchesResultsParams)
	// Retrieve Message Batch results
	...
	BetaMessagesCountTokensPost(w http.ResponseWriter, r *http.Request, params BetaMessagesCountTokensPostParams)
	// Count tokens in a Message
	// (POST /v1/messages/count_tokens?beta=true)
	BetaMessagesCountTokensPost(w http.ResponseWriter, r *http.Request, params BetaMessagesCountTokensPostParams)
	// Create a Message
	// (POST /v1/messages?beta=prompt_caching)
	PromptCachingBetaMessagesPost(w http.ResponseWriter, r *http.Request, params PromptCachingBetaMessagesPostParams)
	// Create a Message
	// (POST /v1/messages?beta=true)
	BetaMessagesPost(w http.ResponseWriter, r *http.Request, params BetaMessagesPostParams)
}
...
// CompletePost operation middleware
func (siw *ServerInterfaceWrapper) CompletePost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params CompletePostParams

	headers := r.Header

	// ------------- Optional header parameter "anthropic-version" -------------
	if valueList, found := headers[http.CanonicalHeaderKey("anthropic-version")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "anthropic-version", valueList[0], &AnthropicVersion, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CompletePost(w, r, params)
	}))
...
// MessagesPost operation middleware
func (siw *ServerInterfaceWrapper) MessagesPost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params MessagesPostParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.MessagesPost(w, r, params)
	}))
...
// BetaMessageBatchesList operation middleware
func (siw *ServerInterfaceWrapper) BetaMessageBatchesList(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessageBatchesListParams
	...
	// ------------- Optional header parameter "anthropic-beta" -------------
	if valueList, found := headers[http.CanonicalHeaderKey("anthropic-beta")]; found {
		var AnthropicBeta string
		n := len(valueList)
		if n != 1 {
			siw.ErrorHandlerFunc(w, r, &TooManyValuesForParamError{ParamName: "anthropic-beta", Count: n})
			return
		}

		err = runtime.BindStyledParameterWithOptions("simple", "anthropic-beta", valueList[0], &AnthropicBeta, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
			siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "anthropic-beta", Err: err})
			return
		}

		params.AnthropicBeta = &AnthropicBeta
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessageBatchesList(w, r, params)
	}))
...
// BetaMessageBatchesPost operation middleware
func (siw *ServerInterfaceWrapper) BetaMessageBatchesPost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessageBatchesPostParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessageBatchesPost(w, r, params)
	}))
...
// BetaMessageBatchesRetrieve operation middleware
func (siw *ServerInterfaceWrapper) BetaMessageBatchesRetrieve(w http.ResponseWriter, r *http.Request) {

	var err error

	// ------------- Path parameter "message_batch_id" -------------
	var messageBatchId string

	err = runtime.BindStyledParameterWithOptions("simple", "message_batch_id", r.PathValue("message_batch_id"), &messageBatchId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "message_batch_id", Err: err})
		return
	}

	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessageBatchesRetrieveParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessageBatchesRetrieve(w, r, messageBatchId, params)
	}))
...
// BetaMessageBatchesCancel operation middleware
func (siw *ServerInterfaceWrapper) BetaMessageBatchesCancel(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessageBatchesCancelParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessageBatchesCancel(w, r, messageBatchId, params)
	}))
...
// BetaMessageBatchesResults operation middleware
func (siw *ServerInterfaceWrapper) BetaMessageBatchesResults(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessageBatchesResultsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessageBatchesResults(w, r, messageBatchId, params)
	}))
...
// BetaMessagesCountTokensPost operation middleware
func (siw *ServerInterfaceWrapper) BetaMessagesCountTokensPost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessagesCountTokensPostParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessagesCountTokensPost(w, r, params)
	}))
...
// PromptCachingBetaMessagesPost operation middleware
func (siw *ServerInterfaceWrapper) PromptCachingBetaMessagesPost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params PromptCachingBetaMessagesPostParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PromptCachingBetaMessagesPost(w, r, params)
	}))
...
// BetaMessagesPost operation middleware
func (siw *ServerInterfaceWrapper) BetaMessagesPost(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params BetaMessagesPostParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.BetaMessagesPost(w, r, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("POST "+options.BaseURL+"/v1/complete", wrapper.CompletePost)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages", wrapper.MessagesPost)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches", wrapper.BetaMessageBatchesList)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/batches", wrapper.BetaMessageBatchesPost)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches/{message_batch_id}", wrapper.BetaMessageBatchesRetrieve)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/batches/{message_batch_id}/cancel", wrapper.BetaMessageBatchesCancel)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/batches/{message_batch_id}/cancel?beta=true", wrapper.BetaMessageBatchesCancel)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches/{message_batch_id}/results", wrapper.BetaMessageBatchesResults)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches/{message_batch_id}/results?beta=true", wrapper.BetaMessageBatchesResults)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches/{message_batch_id}?beta=true", wrapper.BetaMessageBatchesRetrieve)
	m.HandleFunc("GET "+options.BaseURL+"/v1/messages/batches?beta=true", wrapper.BetaMessageBatchesList)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/batches?beta=true", wrapper.BetaMessageBatchesPost)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/count_tokens", wrapper.BetaMessagesCountTokensPost)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages/count_tokens?beta=true", wrapper.BetaMessagesCountTokensPost)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages?beta=prompt_caching", wrapper.PromptCachingBetaMessagesPost)
	m.HandleFunc("POST "+options.BaseURL+"/v1/messages?beta=true", wrapper.BetaMessagesPost)
